...
<div class="container" style="margin-top:8%;margin-bottom:10%">
    ...
    <div class="progress">
        <div class="progress-bar bg-success" role="progressbar" style="width: 25%; height:250px;" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100">25%</div>
    </div>
