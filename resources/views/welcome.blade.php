                    ...
                    <div class="row">
                        <div class="col-xl-6 col-lg-7 col-md-12">
                            <div class="hero__caption">
                                ...
                                <p data-animation="fadeInLeft" data-delay="0.4s">La mejor manera de aprender es haciendo. Completa desafíos para conseguir recompensas</p>
                                <a href="#" class="btn hero-btn" data-animation="fadeInLeft" data-delay="0.7s">Explorar módulos</a>
                            </div>
                        </div>
                    </div>
                </div>
