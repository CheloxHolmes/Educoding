    ...
    return (function() {
        ...
        2: [function(require, module, exports) {
            ...
            const r = function(t) {
                ...
                l = { sortable: !0, searchable: !0, paging: !0, perPage: 10, perPageSelect: [5, 10, 15, 20, 25], nextPrev: !0, firstLast: !1, prevText: "&lsaquo;", nextText: "&rsaquo;", firstText: "&laquo;", lastText: "&raquo;", ellipsisText: "&hellip;", ascText: "▴", descText: "▾", truncatePager: !0, pagerDelta: 2, scrollY: "", fixedColumns: !0, fixedHeight: !1, header: !0, hiddenHeader: !1, footer: !1, labels: { placeholder: "Buscar...", perPage: "{select} Entradas por página", noRows: "No se encontraron registros", noResults: "No hay resultados para la búsqueda", info: "Mostrando {start} a {end} de {rows} entradas" }, layout: { top: "{select}{search}", bottom: "{info}{pager}" } };
            class o {
                constructor(t, e = {}) {
